...
import AddCategoryModal from "@/components/Admin/Category/Modal/AddCategoryModal";
import EditCategoryModal from "@/components/Admin/Category/Modal/EditCategoryModal";
import DeleteCategoryModal from "@/components/Admin/Category/Modal/DeleteCategoryModal";
...
export default function CategoryTable() {
    ...
    const Categories = Array.from({ length: 1284 }, (_, i) => ({
        id: i + 1,
    ...
    const { isAddCategoryModalOpen, openAddCategoryModal, isEditCategoryModalOpen, openEditCategoryModal, isDeleteCategoryModalOpen, openDeleteCategoryModal } = useCategoryModal();
        ...
        <>
            ...
            <div className="w-full bg-white rounded-xs border border-[#ebebeb]">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 px-5 py-2">
                    ...
                    <p className="text-xs text-[#666666]">
                        Showing {offset + 1} to{" "}
                        {Math.min(offset + itemsPerPage, Categories.length)} of{" "}
