...
export default function DeleteSegmentModal() {
    const { closeDeleteSegmentModal } = useSegmentModal();
    return (
            ...
            <div className="relative w-full max-w-md rounded-[12px] bg-white shadow-2xl">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="relative">
                            <button className="absolute right-0 top-0 rounded-md transition hover:bg-gray-100 cursor-pointer"
                                onClick={closeDeleteSegmentModal}
                            >
                ...
                <div className="px-6 py-5">
                    ...
                    <div className="flex items-center gap-4 rounded-[10px] border border-[#E5E7EB] bg-[#FAFAFA] p-4">
                        <div className="px-5 py-2 text-xs text-[#111111]">
                            <h4>#1</h4>
                        </div>

                        <div className="px-5 py-2 text-xs text-[#555555]">
                            <h4>Car dashboard Panel</h4>
                        </div>
                    </div>
