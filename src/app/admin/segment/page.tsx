...
import SegmentTable from "@/components/Admin/Segment/SegmentTable";
import { SegmentModalProvider } from "@/context/admin/segment-context";
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 mt-5 gap-3">
              <div className="flex w-full h-25 text-center bg-white rounded-sm shadow-md justify-evenly items-center">
                ...
                <div>
                  ...
                  <p className="text-xs">All Segment</p>
